    ...
    $(document).ready(function() {
        ...
        if ( $('#lgx-countdown').length ) {
            ...
            $('#lgx-countdown').countdown(dataTime, function(event) {
                var $this = $(this).html(event.strftime(''
                    ...
                    + '<span class="lgx-days">%D <i> Ngày </i>:</span> '
                    + '<span class="lgx-hr">%H <i> Giờ </i>:</span> '
                    + '<span class="lgx-min">%M <i> Phút </i>:</span> '
                    + '<span class="lgx-sec">%S <i> Giây </i></span>'
                ));
            });
        }
        ...
        if ($('#lgx-owlgallery').length) {
            $("#lgx-owlgallery").owlCarousel({
                ...
                autoplay:true,
                dots: false,
                navText: ["<img src='/homepage/assets/img/arrow-left.png'>","<img src='/homepage/assets/img/arrow-right.png'>"],
                autoplayTimeout: 5000,
                autoplaySpeed: 500,
                nav: true,
                addClassActive : true,
        ...
        if ($('#lgx-owltestimonial').length) {
            $("#lgx-owltestimonial").owlCarousel({
                ...
                autoplay:true,
                dots: true,
                navText: ["<img src='/homepage/assets/img/arrow-left-ash.png'>","<img src='/homepage/assets/img/arrow-right-ash.png'>"],
                autoplayTimeout: 5000,
                autoplaySpeed: 500,
                nav: true,
                addClassActive : true,
